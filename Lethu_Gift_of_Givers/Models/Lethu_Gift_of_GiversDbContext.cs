...
namespace Lethu_Gift_of_Givers.Models
{
    public class Lethu_Gift_of_GiversDbContext : DbContext
    {
        public Lethu_Gift_of_GiversDbContext(DbContextOptions<Lethu_Gift_of_GiversDbContext> options) : base(options)
        {
        }
